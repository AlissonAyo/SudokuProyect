...
=======
>>>>>>> 73a792b7c2211c687988bfcdd2ae6ae437c282b5
...
<<<<<<< HEAD
    ...
    for (int i = 0; i < 3; i++) {
        for (int j = 0; j < 3; j++) {
            ...
            if (num == 0) completo = false;  // Si hay una celda vacÌa, la subcuadrÌcula no est· completa
            if (num != 0) {
                if (numeros[num]) return false;  // N˙mero repetido, subcuadrÌcula inv·lida
=======
    for (int i = 0; i < 3; i++) {
        for (int j = 0; j < 3; j++) {
            int num = tablero[inicioFila + i][inicioColumna + j];
...
<<<<<<< HEAD
    ...
    return completo;  // Devuelve verdadero si la subcuadrÌcula est· completa y correcta
}


// FunciÛn para rellenar el tablero con n˙meros aleatorios en modo f·cil
=======
    return true;
}

// Funci√≥n para rellenar el tablero con n√∫meros aleatorios en modo f√°cil
>>>>>>> 73a792b7c2211c687988bfcdd2ae6ae437c282b5
...
<<<<<<< HEAD
=======
                // Mover la selecci√≥n de la celda con las teclas de direcci√≥n
>>>>>>> 73a792b7c2211c687988bfcdd2ae6ae437c282b5
...
<<<<<<< HEAD
=======
                // Ingresar un valor en la celda usando las teclas num√©ricas
>>>>>>> 73a792b7c2211c687988bfcdd2ae6ae437c282b5
...
int modoDificil() {
    RenderWindow dificil(VideoMode(960, 720), "DifÌcil");
=======
int modoDificil() {
    RenderWindow dificil(VideoMode(960, 720), "Dif√≠cil");
>>>>>>> 73a792b7c2211c687988bfcdd2ae6ae437c282b5
...
<<<<<<< HEAD
        std::cerr << "No se pudo cargar la textura del fondo del modo difÌcil" << std::endl;
=======
...
=======
    RenderWindow automatico(VideoMode(960, 720), "AutomÔøΩtico");
    RectangleShape fondoAutomatico(Vector2f(960, 720));
    Texture texturaAutomatico;
    Sudoku sudokuAutomatico;
    ...
    if (!texturaAutomatico.loadFromFile("Fondos/fondoautomatico.png"))
    {
        std::cerr << "No se pudo cargar la textura del fondo del modo automÔøΩtico" << std::endl;
>>>>>>> 73a792b7c2211c687988bfcdd2ae6ae437c282b5
        return -1;
    }
...
=======
        sudokuAutomatico.dibujar(automatico);  // Dibujar la cuadrÔøΩcula de Sudoku
